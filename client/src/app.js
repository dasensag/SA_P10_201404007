...
app.post('/order', jsonParser, function (req, res) {
  ...
  axios.post('http://esb:6000/order', json, {
    headers: {
...
app.get('/order/:orderId', (req, res) => {
  axios.get('http://esb:6000/order/' + req.params.orderId).then(function (response) {
...
app.get('/delivery/:orderId', (req, res) => {
  axios.get('http://esb:6000/delivery/' + req.params.orderId).then(function (response) {
    log.info('GET /order/', req.params.orderId, ' ', response.data)
    res.json(response.data)
  })
})
